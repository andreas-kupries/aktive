...
<tr><td valign='top'><img src='example-00647.gif' alt='@1' style='border:4px solid gold'>
    ...
    <td valign='top'><img src='example-00648.gif' alt='@2 ({linear light})' style='border:4px solid gold'>
    <br>geometry(0 0 380 250 3)</td>
    <td valign='top'><img src='example-00649.gif' alt='aktive op structure lines @2' style='border:4px solid gold'>
...
<tr><td valign='top'><img src='example-00650.gif' alt='@1' style='border:4px solid gold'>
    ...
    <br>geometry(0 0 380 250 3)</td>
    <td valign='top'><img src='example-00652.gif' alt='lindex [aktive op structure tensor @2] 0 (XX)' style='border:4px solid gold'>
    <br>geometry(0 0 380 250 1)</td></tr>
</table>
...
<tr><td valign='top'><img src='example-00653.gif' alt='@1' style='border:4px solid gold'>
    ...
    <br>geometry(0 0 380 250 3)</td>
    <td valign='top'><img src='example-00655.gif' alt='lindex [aktive op structure tensor @2] 1 (YY)' style='border:4px solid gold'>
    <br>geometry(0 0 380 250 1)</td></tr>
</table>
...
<tr><td valign='top'><img src='example-00656.gif' alt='@1' style='border:4px solid gold'>
    ...
    <br>geometry(0 0 380 250 3)</td>
    <td valign='top'><img src='example-00658.gif' alt='lindex [aktive op structure tensor @2] 2 (XY)' style='border:4px solid gold'>
    <br>geometry(0 0 380 250 1)</td></tr>
</table>
