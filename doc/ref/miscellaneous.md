...
Syntax: __aktive error__ m args... [[→ definition](/file?ci=trunk&ln=194&name=etc/aktive.tcl)]
...
Syntax: __aktive processors__ n [[→ definition](/file?ci=trunk&ln=211&name=etc/aktive.tcl)]
