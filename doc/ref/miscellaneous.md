...
Syntax: __aktive error__ m args... [[→ definition](/file?ci=trunk&ln=188&name=etc/aktive.tcl)]
...
Syntax: __aktive processors__ n [[→ definition](/file?ci=trunk&ln=205&name=etc/aktive.tcl)]
...
Syntax: __aktive version__  [[→ definition](/file?ci=trunk&ln=198&name=etc/aktive.tcl)]
