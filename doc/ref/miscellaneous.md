...
Syntax: __aktive error__ m args... [[→ definition](/file?ci=trunk&ln=191&name=etc/aktive.tcl)]
...
Syntax: __aktive processors__ n [[→ definition](/file?ci=trunk&ln=208&name=etc/aktive.tcl)]
...
Syntax: __aktive version__  [[→ definition](/file?ci=trunk&ln=201&name=etc/aktive.tcl)]
