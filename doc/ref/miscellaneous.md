...
Syntax: __aktive error__ m args... [[→ definition](/file?ci=trunk&ln=189&name=etc/aktive.tcl)]
...
Syntax: __aktive processors__ n [[→ definition](/file?ci=trunk&ln=206&name=etc/aktive.tcl)]
...
Syntax: __aktive version__  [[→ definition](/file?ci=trunk&ln=199&name=etc/aktive.tcl)]
