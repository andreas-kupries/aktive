...
Syntax: __aktive op math and__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
...
Syntax: __aktive op math or__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
...
Syntax: __aktive op math xor__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
