...
Syntax: __aktive op math add__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
...
Syntax: __aktive op math max__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
...
Syntax: __aktive op math min__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
...
Syntax: __aktive op math mul__ srcs... [[→ definition](/file?ci=trunk&ln=137&name=etc/transformer/math/binary.tcl)]
