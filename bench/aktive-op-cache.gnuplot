...
unset logscale
plot datasource2 using 1:(1)	 with lines, \
     datasource2 using 1:($2/$3) with lines title "cache/aktive"
...
unset logscale
plot datasource3 using 1:(1)	 with lines, \
     datasource3 using 1:($2/$3) with lines title "cache/netpbm"
